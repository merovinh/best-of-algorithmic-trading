...
- [GitHub](https://github.com/freqtrade/freqtrade) (👨‍💻 290 · 🔀 4.2K · 📋 3.6K - 1% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/Drakkar-Software/OctoBot) (👨‍💻 24 · 🔀 510 · 📥 3.8K · 📋 710 - 12% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/jesse-ai/jesse) (👨‍💻 43 · 🔀 570 · 📦 21 · 📋 92 - 4% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/ccxt/ccxt) (👨‍💻 720 · 🔀 6.2K · 📦 3.9K · 📋 8.1K - 8% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/ccxt/ccxt
	```
- [npm](https://www.npmjs.com/package/ccxt) (📥 83K / month):
	```
	npm install ccxt
	```
</details>
<details><summary><b><a href="https://github.com/sammchardy/python-binance">python-binance</a></b> (🥇28 ·  ⭐ 5K · 💤) - Binance Exchange API python implementation for automated.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>
...
- [GitHub](https://github.com/tiagosiebler/binance) (👨‍💻 39 · 🔀 180 · 📦 800 · 📋 140 - 17% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/tiagosiebler/binance
	```
- [npm](https://www.npmjs.com/package/binance) (📥 8.5K / month):
	```
	npm install binance
	```
</details>
...
- [GitHub](https://github.com/tiagosiebler/bybit-api) (👨‍💻 19 · 🔀 46 · 📦 92 · 📋 77 - 15% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/tiagosiebler/bybit-api
	```
- [npm](https://www.npmjs.com/package/bybit-api) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/tiagosiebler/ftx-api) (👨‍💻 14 · 🔀 50 · 📦 94 · 📋 34 - 2% open · ⏱️ 29.11.2022):
