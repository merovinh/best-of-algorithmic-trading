...
- [GitHub](https://github.com/freqtrade/freqtrade) (👨‍💻 330 · 🔀 5.5K · 📦 56 · 📋 4.5K - 0% open · ⏱️ 30.05.2024):
...
- [GitHub](https://github.com/QuantConnect/Lean) (👨‍💻 200 · 🔀 3K · 📦 21 · 📋 3.1K - 6% open · ⏱️ 30.05.2024):
...
- [GitHub](https://github.com/Drakkar-Software/OctoBot) (👨‍💻 25 · 🔀 690 · 📥 8.9K · 📋 730 - 11% open · ⏱️ 24.05.2024):

	```
	git clone https://github.com/Drakkar-Software/OctoBot
	```
</details>
<details><summary><b><a href="https://github.com/jesse-ai/jesse">Jesse</a></b> (🥈21 ·  ⭐ 5.3K) - An advanced crypto trading bot written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <code><img src="https://www.python.org/static/favicon.ico" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub](https://github.com/jesse-ai/jesse) (👨‍💻 47 · 🔀 670 · 📋 100 - 1% open · ⏱️ 29.05.2024):
...
- [GitHub](https://github.com/tiagosiebler/binance) (👨‍💻 57 · 🔀 240 · 📦 1.1K · 📋 180 - 16% open · ⏱️ 29.05.2024):

	```
	git clone https://github.com/tiagosiebler/binance
	```
- [npm](https://www.npmjs.com/package/binance) (📥 8.9K / month):
	```
	npm install binance
	```
</details>
